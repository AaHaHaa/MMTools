function output = build_3Dgaussian(MFD, spatial_window, tfwhm, time_window, energy, Nt, Nx, varargin)
%BUILD_3DGAUSSIAN Build a 3D temporally-superGaussian pulse with a Gaussian spatial profile using the following parameters:
%
...
spatial_profile = build_2Dgaussian(MFD, spatial_window, Nx, x_center, y_center, gaussexpo);
