function [A1,...
          ...
          N2] = stepping_MPA_rategain_rmc(A0, A0_backward,...
...
%STEPPING_MPA_RATEGAIN_RMC Take one step with MPA with a gain model solved 
...
for n_it = 1:sim.MPA.n_tot_max
    ...
    % Incorporate small_deltaZ and exp(-D*z) term for trapezoidal integration
    nonlinear = add_D_and_rmc(false,...
                              D,rmc_D,...
                              sim.small_deltaZ*nonlinear + gain_term,...
                              N,num_modes,sim.MPA.M+1,...
