function kernel = setup_kernel_mypagemtimes(filename,cuda_dir_path,N,M,num_modes)
...
if num_modes > sqrt(kernel.MaxThreadsPerBlock)
    error('setup_kernel_mypagemtimes:num_modesError',...
