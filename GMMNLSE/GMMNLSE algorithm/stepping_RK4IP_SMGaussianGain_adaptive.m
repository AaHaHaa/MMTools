function [A1w,a5,...
          opt_dz,success] = stepping_RK4IP_SMGaussianGain_adaptive(A0w, dt,...
                                                                   sim, n2_prefactor,...
...
total_energy = calc_total_energy(A0w,Nt,dt); % in nJ
...
%% helper function
function total_energy = calc_total_energy(A,Nt,dt)
%CALC_TOTAL_ENERGY
...
total_energy = ( sum(A2(:))-sum(sum(A2([center_idx,center_idx+1],:)))/2 )*Nt*dt/1e3; % nJ;
