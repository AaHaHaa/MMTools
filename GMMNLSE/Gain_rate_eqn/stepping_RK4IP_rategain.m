function [A1,...
          ...
          N2] = stepping_RK4IP_rategain(A0, A0_backward,...
...
%    D - dispersion term Dz/2 (N, num_modes)
%
...
[Power_pump_forward,Power_ASE_forward,...
 G,N2] = solve_gain_rate_eqn('forward',...
                             sim,gain_rate_eqn,...
                             A0,A0_backward,Power_pump_forward,Power_pump_backward,Power_ASE_forward,Power_ASE_backward,...
                             omegas,dt,...
                             first_backward_before_iterations );
...
a1 = expDG.*N_op(        A0,                     sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, sponRS_Gamma, anisotropic_Raman_included, prefactor, N, num_modes);
