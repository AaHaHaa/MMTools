...
function [absorption,emission] = read_cross_sections_Yb_Nd(filename, lambda)
%READ_CROSS_SECTIONS_YB_ND This reads the absorption and emission cross 
%sections of Yb or Nd.
