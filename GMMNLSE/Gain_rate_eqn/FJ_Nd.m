...
N0  = N_total - sum(N,1); % ground state, 4I9/2
N1  = N( 1,:,:,:,:,:,:,:); % 4I11/2
N2  = N( 2,:,:,:,:,:,:,:); % 4I13/2
N3  = N( 3,:,:,:,:,:,:,:); % 4I15/2
N4  = N( 4,:,:,:,:,:,:,:); % 4F3/2
...
dNdt = cat(1,dN1dt,dN2dt,dN3dt,dN4dt,dN5dt,dN6dt,dN7dt,dN8dt,dN9dt,dN10dt,dN11dt);

end

function Jacobian_Nd = J(N,N_total,A,Gamma,kijkl,R)
...
% Jacobian matrix
dN1dt_N1 = - A(2,1) - Gamma(1);
dN1dt_N2 = A(3,2) + Gamma(2);
dN1dt_N3 = A(4,2);
dN1dt_N4 = A(5,2) + we41 + 2*N4*k440110;
dN1dt_N5 = A(6,2);
dN1dt_N6 = A(7,2);
dN1dt_N7 = A(8,2);
dN1dt_N8 = A(9,2);
...
dN1dt_N11 = A(12,2);
%dN2dt_N1 = 0;
dN2dt_N2 = - A(3,1) - A(3,2) - Gamma(2);
dN2dt_N3 = A(4,3) + Gamma(3);
dN2dt_N4 = A(5,3) + we42 + 2*N4*k4429;
dN2dt_N5 = A(6,3);
dN2dt_N6 = A(7,3);
dN2dt_N7 = A(8,3);
dN2dt_N8 = A(9,3);
...
dN2dt_N10 = A(11,3);
dN2dt_N11 = A(12,3);
dN3dt_N1 = - wa03 - 2*N4*k4033;
dN3dt_N2 = - wa03 - 2*N4*k4033;
dN3dt_N3 = - A(4,1) - A(4,2) - A(4,3) - Gamma(3) - wa03 - 2*N4*k4033;
dN3dt_N4 = A(5,4) + Gamma(4) - wa03 + 2*N4*k4438 + 2*k4033*(N0 - N4);
dN3dt_N5 = A(6,4) - wa03 - 2*N4*k4033;
dN3dt_N6 = A(7,4) - wa03 - 2*N4*k4033;
dN3dt_N7 = A(8,4) - wa03 - 2*N4*k4033;
dN3dt_N8 = A(9,4) - wa03 - 2*N4*k4033;
dN3dt_N9 = A(10,4) - wa03 - 2*N4*k4033;
dN3dt_N10 = A(11,4) - wa03 - 2*N4*k4033;
dN3dt_N11 = A(12,4) - wa03 - 2*N4*k4033;
dN4dt_N1 = N4*k4033 - wa04;
dN4dt_N2 = N4*k4033 - wa04;
dN4dt_N3 = N4*k4033 - wa04;
dN4dt_N4 = (N4 - N0)*k4033 - A(5,2) - A(5,3) - A(5,4) - Gamma(4) - wa04 - wa49 - we40 - we41 - we42 - A(5,1) - 2*N4*(2*k4429 + 2*k4438 + 2*k440011 + 2*k440110);
dN4dt_N5 = A(6,5) + Gamma(5) - wa04 + N4*k4033;
dN4dt_N6 = A(7,5) - wa04 + N4*k4033;
dN4dt_N7 = A(8,5) - wa04 + N4*k4033;
dN4dt_N8 = A(9,5) - wa04 + N4*k4033;
dN4dt_N9 = A(10,5) - wa04 + N4*k4033;
dN4dt_N10 = A(11,5) - wa04 + N4*k4033;
dN4dt_N11 = A(12,5) - wa04 + N4*k4033;
dN5dt_N1 = - wa05;
dN5dt_N2 = - wa05;
dN5dt_N3 = - wa05;
dN5dt_N4 = - wa05;
dN5dt_N5 = - A(6,1) - A(6,2) - A(6,3) - A(6,4) - A(6,5) - Gamma(5) - wa05;
dN5dt_N6 = A(7,6) + Gamma(6) - wa05;
dN5dt_N7 = A(8,6) - wa05;
dN5dt_N8 = A(9,6) - wa05;
dN5dt_N9 = A(10,6) - wa05;
dN5dt_N10 = A(11,6) - wa05;
dN5dt_N11 = A(12,6) - wa05;
dN6dt_N1 = - wa06;
dN6dt_N2 = - wa06;
dN6dt_N3 = - wa06;
dN6dt_N4 = - wa06;
...
dN6dt_N8 = A(9,7) - wa06;
dN6dt_N9 = A(10,7) - wa06;
dN6dt_N10 = A(11,7) - wa06;
dN6dt_N11 = A(12,7) - wa06;
dN7dt_N1 = - wa07;
dN7dt_N2 = - wa07;
dN7dt_N3 = - wa07;
dN7dt_N4 = - wa07;
...
dN7dt_N9 = A(10,8) - wa07;
dN7dt_N10 = A(11,8) - wa07;
dN7dt_N11 = A(12,8) - wa07;
dN8dt_N1 = - wa08;
dN8dt_N2 = - wa08;
dN8dt_N3 = - wa08;
dN8dt_N4 = 2*N4*k4438 - wa08;
dN8dt_N5 = - wa08;
dN8dt_N6 = - wa08;
dN8dt_N7 = - wa08;
dN8dt_N8 = - A(9,1) - A(9,2) - A(9,3) - A(9,4) - A(9,5) - A(9,6) - A(9,7) - A(9,8) - Gamma(8) - wa08;
dN8dt_N9 = A(10,9) + Gamma(9) - wa08;
dN8dt_N10 = A(11,9) - wa08;
dN8dt_N11 = A(12,9) - wa08;
dN9dt_N1 = - wa09;
dN9dt_N2 = - wa09;
dN9dt_N3 = - wa09;
dN9dt_N4 = wa49 - wa09 + 2*N4*k4429;
dN9dt_N5 = - wa09;
dN9dt_N6 = - wa09;
dN9dt_N7 = - wa09;
dN9dt_N8 = - wa09;
dN9dt_N9 = - A(10,1) - A(10,2) - A(10,3) - A(10,4) - A(10,5) - A(10,6) - A(10,7) - A(10,8) - A(10,9) - Gamma(9) - wa09;
dN9dt_N10 = A(11,10) + Gamma(10) - wa09;
dN9dt_N11 = A(12,10) - wa09;
dN10dt_N1 = - wa0010;
dN10dt_N2 = - wa0010;
dN10dt_N3 = - wa0010;
dN10dt_N4 = 2*N4*k440110 - wa0010;
dN10dt_N5 = - wa0010;
dN10dt_N6 = - wa0010;
dN10dt_N7 = - wa0010;
dN10dt_N8 = - wa0010;
dN10dt_N9 = - wa0010;
dN10dt_N10 = - A(11,1) - A(11,2) - A(11,3) - A(11,4) - A(11,5) - A(11,6) - A(11,7) - A(11,8) - A(11,9) - A(11,10) - Gamma(10) - wa0010;
dN10dt_N11 = A(12,11) + Gamma(11) - wa0010;
dN11dt_N1 = - wa0011;
dN11dt_N2 = - wa0011;
dN11dt_N3 = - wa0011;
dN11dt_N4 = 2*N4*k440011 - wa0011;
dN11dt_N5 = - wa0011;
dN11dt_N6 = - wa0011;
dN11dt_N7 = - wa0011;
dN11dt_N8 = - wa0011;
dN11dt_N9 = - wa0011;
dN11dt_N10 = - wa0011;
dN11dt_N11 = - A(12,1) - A(12,2) - A(12,3) - A(12,4) - A(12,5) - A(12,6) - A(12,7) - A(12,8) - A(12,9) - A(12,10) - A(12,11) - Gamma(11) - wa0011;
...
dN1dt_N11 = repmat(dN1dt_N11,1,1,num_x,num_y,1,1,1,M);
dN2dt_N1 = zeros(1,1,num_x,num_y,1,1,1,M); % = repmat(dN2dt_N1,1,1,num_x,num_y,1,1,1,M);
...
dN2dt_N11 = repmat(dN2dt_N11,1,1,num_x,num_y,1,1,1,M);

Jacobian_Nd = cat(1,cat(2,dN1dt_N1,dN1dt_N2,dN1dt_N3,dN1dt_N4,dN1dt_N5,dN1dt_N6,dN1dt_N7,dN1dt_N8,dN1dt_N9,dN1dt_N10,dN1dt_N11),...
                    cat(2,dN2dt_N1,dN2dt_N2,dN2dt_N3,dN2dt_N4,dN2dt_N5,dN2dt_N6,dN2dt_N7,dN2dt_N8,dN2dt_N9,dN2dt_N10,dN2dt_N11),...
                    cat(2,dN3dt_N1,dN3dt_N2,dN3dt_N3,dN3dt_N4,dN3dt_N5,dN3dt_N6,dN3dt_N7,dN3dt_N8,dN3dt_N9,dN3dt_N10,dN3dt_N11),...
                    cat(2,dN4dt_N1,dN4dt_N2,dN4dt_N3,dN4dt_N4,dN4dt_N5,dN4dt_N6,dN4dt_N7,dN4dt_N8,dN4dt_N9,dN4dt_N10,dN4dt_N11),...
                    cat(2,dN5dt_N1,dN5dt_N2,dN5dt_N3,dN5dt_N4,dN5dt_N5,dN5dt_N6,dN5dt_N7,dN5dt_N8,dN5dt_N9,dN5dt_N10,dN5dt_N11),...
                    cat(2,dN6dt_N1,dN6dt_N2,dN6dt_N3,dN6dt_N4,dN6dt_N5,dN6dt_N6,dN6dt_N7,dN6dt_N8,dN6dt_N9,dN6dt_N10,dN6dt_N11),...
                    cat(2,dN7dt_N1,dN7dt_N2,dN7dt_N3,dN7dt_N4,dN7dt_N5,dN7dt_N6,dN7dt_N7,dN7dt_N8,dN7dt_N9,dN7dt_N10,dN7dt_N11),...
                    cat(2,dN8dt_N1,dN8dt_N2,dN8dt_N3,dN8dt_N4,dN8dt_N5,dN8dt_N6,dN8dt_N7,dN8dt_N8,dN8dt_N9,dN8dt_N10,dN8dt_N11),...
                    cat(2,dN9dt_N1,dN9dt_N2,dN9dt_N3,dN9dt_N4,dN9dt_N5,dN9dt_N6,dN9dt_N7,dN9dt_N8,dN9dt_N9,dN9dt_N10,dN9dt_N11),...
                    cat(2,dN10dt_N1,dN10dt_N2,dN10dt_N3,dN10dt_N4,dN10dt_N5,dN10dt_N6,dN10dt_N7,dN10dt_N8,dN10dt_N9,dN10dt_N10,dN10dt_N11),...
                    cat(2,dN11dt_N1,dN11dt_N2,dN11dt_N3,dN11dt_N4,dN11dt_N5,dN11dt_N6,dN11dt_N7,dN11dt_N8,dN11dt_N9,dN11dt_N10,dN11dt_N11));
