...
sim_Gain.progress_bar_name = 'Gain (20um)';
fiber_Gain.L0 = 5.7;
fiber_Gain.MFD = sqrt(410/pi)*2;
fiber_Gain.n2 = 3.07e-20;
...
gain_rate_eqn.counterpump_power = 31*0.9; % W
...
spectrum = abs(fftshift(ifft(output_field),1)).^2*factor_correct_unit; % in frequency domain
