% This code computes the 6-um Yb linear Mamyshev oscillator with only one
...
while rt_num < max_rt
    ...
    [filtered_output,fig_filter] = gaussian_spectral_filter(prop_output, sim.f0, spectral_filter(1).cw, spectral_filter(1).bw, gaussexpo ,plot_filter_yes); % Filter
    % Loss
...
if pulse_survives
    save('linear_Mamyshev_oscillator_withASE.mat', 't','f','output_field','time_delay','energy',...
                                                   ...
                                                   'pump','N1','ASE','gain_rate_eqn_copumping','gain_rate_eqn_counterpumping',...
