...
sim.save_period = 0.1;
sim.num_photon_noise_per_band = 1; % include noise to the seed
sim.Raman_sponRS = true; % include spontaneous Raman
sim.ellipticity = 1;
% -------------------------------------------------------------------------
...
gain_rate_eqn.copump_power = 1.3; % W
...
[Strehl_ratio,dechirped_FWHM,transform_limited_FWHM,peak_power] = analyze_field( t,f,prop_output.fields(:,1,end),'Treacy-t',pi/6,1e-6 );
