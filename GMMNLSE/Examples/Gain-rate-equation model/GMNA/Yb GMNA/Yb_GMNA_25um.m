% This code solves the 25-um-core Yb-doped gain-managed fiber amplifier 
% (GMNA).
...
sim_Gain.progress_bar_name = 'Gain (25um)';
fiber_Gain.L0 = 3; % m; fiber length
fiber_Gain.MFD = 20; % um; mode-field diameter
...
gain_rate_eqn.absorption_to_get_N_total = 5.1; % dB/m
