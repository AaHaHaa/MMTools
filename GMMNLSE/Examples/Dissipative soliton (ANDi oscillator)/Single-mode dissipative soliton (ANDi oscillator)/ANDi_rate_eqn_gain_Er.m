...
% Liu et al., "Self-similar erbium-doped fiber laser with large normal
% dispersion," Opt. Lett. 39, 1019-1021 (2014)
...
fiber_ND = fiber6;
fiber_ND.L0 = 0.5;
fiber_ND.betas = [5.8126e6, 4.8754e3, 6.0244e-3, 53.7064e-6, -265.0082e-9]';
...
fiber_Gain.L0 = 3;
fiber_Gain.MFD = 6;
fiber_Gain.betas = [5.8126e6, 4.8754e3, 6.0244e-3, 53.7064e-6, -265.0082e-9]';
[fiber_Gain,sim_Gain] = load_default_GMMNLSE_propagate(fiber_Gain,sim_Gain,'single_mode'); % for the gain fibers

% -------------------------------------------------------------------------
% ----------------------------------- All ---------------------------------
% -------------------------------------------------------------------------
fiber_cavity = [fiber_6a fiber_ND fiber_Gain fiber_ND];
sim_cavity = [sim6 sim6 sim_Gain sim6];
