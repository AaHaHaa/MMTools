...
% General parameters
sim.lambda0 = 920e-9; % m; center wavelength
sim.f0 = 2.99792458e-4/sim.lambda0; % THz; center frequency
%sim.progress_bar = false;
sim.gpu_yes = false; % use GPU or not

sim4 = sim; % for the passive fibers
sim4.progress_bar_name = 'SMF (4um)';
sim4.save_period = 0.1; % m

[fiber4,sim4] = load_default_GMMNLSE_propagate([],sim4,'single_mode'); % for the passive fibers
fiber4.betas = [9.8810e6; 4.8872e3; 0.0315; 2.0457e-5; 1.2737e-9];
fiber4.MFD = 4;
...
% Gain fiber
sim_Gain_4 = sim;
sim_Gain_4.gain_model = 2; % use the rate-eqn-gain model
sim_Gain_4.progress_bar_name = 'Gain (6um)';
sim_Gain_4.save_period = 0.01; % m
fiber_Gain_4.L0 = 5;
fiber_Gain_4.MFD = 4.7;
fiber_Gain_4.betas = fiber4.betas;
[fiber_Gain_4,sim_Gain_4] = load_default_GMMNLSE_propagate(fiber_Gain_4,sim_Gain_4,'single_mode'); % for the gain fibers
...
% ----------------------------------- All ---------------------------------
% -------------------------------------------------------------------------
fiber_cavity = [fiber_4a fiber_Gain_4 fiber_4b];
sim_cavity = [sim4 sim_Gain_4 sim4];
...
gain_rate_eqn = gain_info( fiber_Gain_4,sim_Gain_4,gain_rate_eqn,ifftshift(lambda,1) );
...
if pulse_survives
    save('ANDi_Nd.mat', 't','f','lambda','output_field','energy',...
