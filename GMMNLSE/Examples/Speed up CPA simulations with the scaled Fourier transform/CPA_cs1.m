% This code runs a CPA "without" narrowband transformation to speed up
% simulations. It's used as a benchmark for the "CPA_cs.m" with narrowband
% transformation.
% The pulse is initially stretched by a long passive fiber.
%
