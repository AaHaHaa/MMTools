% This code shows the soliton trapping for vector solitons of equal amplitude.
% The example is from Ch.6.5.2 of Nonlinear Fiber Optics (5ed), Agrawal.
% Check its Fig.6.13 and 6.14.
%
...
%
% load fiber.betas and fiber.SR based on your multimode folder
...
Aeff = (fiber.MFD*1e-6/2)^2*pi; % mode area; m^2

% solitons
initial_pulse = build_MMsoliton(tfwhm, fiber.betas(3), 1/Aeff, sim.lambda0, time_window, 1, Nt);
...
%% Save the data
save('vector_soliton_equal_amplitude.mat');