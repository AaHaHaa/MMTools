% This code demonstrates the self-phase modulation of a (highly-)negatively-chirped pulse.
%
...
% wrapping.
% A initially negatively-chirped pulse creates a frequency wrapping that 
% induces three temporal interences of each color, leading to significant 
% spectral modulations (more than the transform-limited case).
% See Fig. 11 in the reference below.
% 
%
% Reference:
...
chirp_sign = -1; % negatively-chirped
...
%% Save the data
save('SPM_of_negatively_chirped_pulse.mat');