...
alpha = 45*pi/180;
incident_angle = 37.3; % deg
grating_spacing = 1e-3/1000; % m
[dechirped_separation_grism,optimal_FWHM_grism,dechirped_field_grism,grism_height] = pulse_compressor( 'grism1',incident_angle*pi/180,sim.lambda0*1e9,t,prop_output.fields(:,:,end),grating_spacing,alpha,'N-SF11',false,true );
