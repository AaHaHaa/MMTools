function Ef_out = add_spherical_lens_phase_r(Ef,r,wavelength,radius_of_curvature,varargin)
%ADD_SPERICALLENS_PHASE_R It adds a spherical-lens phase for a 3D electric
...
%   Ef: electric field in the frequency domain(=ifft(Et,[],1)); size: (Nt,Nr,Nz)
...
r2 = r.^2;
dr = abs(radius_of_curvature) - sqrt(radius_of_curvature^2 - r2);

beyond_lens = (radius_of_curvature < r);
...
beyond_lens = repmat(beyond_lens,[Nt,1,Nz]);
