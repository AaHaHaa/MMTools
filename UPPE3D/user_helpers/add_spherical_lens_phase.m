function Ef_out = add_spherical_lens_phase(Ef,dx,dy,wavelength,radius_of_curvature,varargin)
%ADD_SPERICALLENS_PHASE It adds a spherical-lens phase for a 3D electric field
